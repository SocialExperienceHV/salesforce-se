...
import {
  ...
  List, BarChart3, Settings, ChevronLeft, Wallet, Receipt, CreditCard, FileSpreadsheet, ClipboardCheck, Target
} from 'lucide-react'
...
const ALL_NAV = [
  ...
  { href: '/dashboard-comercial', label: 'Dashboard Comercial', icon: Target },
